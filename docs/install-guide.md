...
5. [Optional] Update default credentials in .env.original
  > Note: due to the huge refactoring better to ask assistance in updating credentials for all configuration files. In 5.1 it is planned to have single point of true only inside .env.original!
