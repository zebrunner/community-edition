...
<#function multiJoin array1=[] array2=[]>
  <#return ((array1?? && array1?size != 0) || ! array2??)?then(join(array1), join(array2)) />
	...
	CHART_CONFIG='{"columns": ["BUG", "SUBJECT", "PROJECT", "ENV", "OWNER", "PLATFORM", "PLATFORM_VERSION", "BROWSER", "BROWSER_VERSION", "APP_VERSION", "DEVICE", "LOCALE", "SUITE NAME", "TEST_INFO_URL", "Error Message"]}', 
	PARAMS_CONFIG='{
  "PERIOD": {
    "values": [
      "Last 24 Hours",
  ...
  "PARENT_BUILD": {
	...
	LEGEND_CONFIG='{"legend": ["BUG", "SUBJECT", "PROJECT", "ENV", "OWNER", "PLATFORM", "PLATFORM_VERSION", "BROWSER", "BROWSER_VERSION", "APP_VERSION", "DEVICE", "LOCALE", "SUITE NAME", "TEST_INFO_URL", "Error Message"]}', 
	PARAMS_CONFIG_SAMPLE='{
  "PERIOD": "Last 30 Days",
  "PERSONAL": "false",
  "currentUserId": 1,
