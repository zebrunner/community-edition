...
then
    psql --username $POSTGRES_USER -c "UPDATE zafira.SETTINGS SET VALUE='$RABBITMQ_ENABLED' WHERE NAME='RABBITMQ_ENABLED';"
    psql --username $POSTGRES_USER -c "UPDATE zafira.SETTINGS SET VALUE='$RABBITMQ_HOST' WHERE NAME='RABBITMQ_HOST';"
    psql --username $POSTGRES_USER -c "UPDATE zafira.SETTINGS SET VALUE='$RABBITMQ_PORT' WHERE NAME='RABBITMQ_PORT';"
    psql --username $POSTGRES_USER -c "UPDATE zafira.SETTINGS SET VALUE='$RABBITMQ_USERNAME' WHERE NAME='RABBITMQ_USER';"
    psql --username $POSTGRES_USER -c "UPDATE zafira.SETTINGS SET VALUE='$RABBITMQ_PASSWORD' WHERE NAME='RABBITMQ_PASSWORD';"
fi
