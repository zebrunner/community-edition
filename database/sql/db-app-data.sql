...
DO $$
	...
	-- Lambda test
        ...
        INSERT INTO INTEGRATION_PARAMS(NAME, METADATA, MANDATORY, INTEGRATION_TYPE_ID, NEED_ENCRYPTION) VALUES ('JENKINS_JOB_URL_VISIBILITY', '{"paramType": "BOOLEAN"}', TRUE, INTEGRATION_TYPE_ID, FALSE) RETURNING ID INTO INTEGRATION_PARAM_ID;
